...
model = dict(
    ...
    predictor=dict(
        ...
        dropout=0.01,
        num_temporal_layers=2, # default = 3
        num_global_layers=2,
        local_radius=8.0, # default = 5.0
        parallel=False,
        lr=0.01,
        weight_decay=1e-3,
        T_max=0,
...
data = dict(
    ...
    train=dict(
        ...
        data_root=data_root,
        ann_file=data_root + 'nuscenes_tracking_quarter_infos_train.pkl',
    ...
    val=dict(type=dataset_type, pipeline_single=test_pipeline, pipeline_post=test_pipeline_post, classes=class_names, modality=input_modality,
             ann_file=data_root + 'nuscenes_tracking_quarter_infos_val.pkl',
