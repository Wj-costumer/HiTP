...
def create_nuscenes_infos(root_path,
    ...
    if version == 'v1.0-trainval':
        ...
        train_quarter = len(splits.train) // 5
        val_quarter = len(splits.val) // 5
        train_scenes = splits.train[:train_quarter]
        val_scenes = splits.val[:val_quarter]
...
def _fill_trainval_infos(nusc: NuScenes,
    ...
    for sample in mmcv.track_iter_progress(nusc.sample):   
        ...
        lidar_path, boxes, _ = nusc.get_sample_data(lidar_token) # get_sample_data函数获得的boxes参考系为对应token的基准系 boxes in lidar coordinate
...
if __name__ == '__main__':
    create_nuscenes_infos('data/nuscenes/', 'nuscenes_tracking_quarter')